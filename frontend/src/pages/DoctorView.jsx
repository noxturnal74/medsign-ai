    ...
    <div className="flex w-full flex-col gap-6 animate-slide-up">
      ...
      <div className="glass-panel flex items-center justify-between rounded-3xl p-4">
        ...
        <div className="flex items-center gap-2.5">
          <div className="flex h-9 w-9 items-center justify-center rounded-2xl bg-emerald-500/10 text-emerald-600 shrink-0">
            <Stethoscope size={17} />
          </div>
          <div className="text-left">
            <span className="block text-[10px] font-bold uppercase text-emerald-700 leading-none">Konsultasi Aktif</span>
            <h2 className="text-sm md:text-base font-black text-slate-950 mt-1 leading-none">Layar Diagnosis Dokter</h2>
          </div>
        </div>
