...
import { Instagram, CheckCircle2, AlertTriangle, Volume2, Mail, Send, MapPin, X } from 'lucide-react';
        ...
        return (
          ...
          <div 
            ...
            style={position.x !== null ? (() => {
              const btnSize = 80;
              const s = { position: "fixed", zIndex: 50 };
              if (isLeftHalf) {
                s.left = position.x;
                s.right = "auto";
              } else {
                s.right = window.innerWidth - (position.x + btnSize);
                s.left = "auto";
              }
              if (isUpperHalf) {
                s.top = position.y;
                ...
                s.bottom = window.innerHeight - (position.y + btnSize);
                s.top = "auto";
              }
              return s;
            })() : {}}
      ...
      {toast && (
        ...
        <>
          ...
          <div 
            ...
            className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-[999998] animate-fade-in"
          ...
          <div 
            ...
            className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[999999] bg-white rounded-[28px] p-6 max-w-sm w-[90%] shadow-2xl flex flex-col items-center text-center border border-slate-100/80 animate-scale-up select-none text-slate-800"
          ...
          >
            ...
            {toast.type === "success" && (
              ...
              <div className="w-14 h-14 rounded-full bg-emerald-50 flex items-center justify-center mb-4 mt-2 ring-8 ring-emerald-50/50">
            ...
            {toast.type === "error" && (
              ...
              <div className="w-14 h-14 rounded-full bg-rose-50 flex items-center justify-center mb-4 mt-2 ring-8 ring-rose-50/50">
            ...
            {toast.type === "info" && (
              ...
              <div className="w-14 h-14 rounded-full bg-sky-50 flex items-center justify-center mb-4 mt-2 ring-8 ring-sky-50/50">

                <Volume2 size={24} className="text-sky-500 shrink-0" />
            ...
            <h3 className="text-sm font-black text-slate-950 mb-2 mt-1">

              {toast.type === "success" && "Berhasil!"}

              {toast.type === "error" && "Terjadi Kesalahan"}

              {toast.type === "info" && "Pemberitahuan"}
            ...
            <p className="text-[11px] font-semibold text-slate-500 leading-relaxed mb-6 px-2">
            ...
            <button
              ...
              className="w-full py-3 bg-slate-950 text-white rounded-2xl text-[10px] font-black uppercase tracking-wider hover:bg-slate-900 transition-colors"

            >

              {toast.type === "error" ? "Coba Lagi" : "OK"}
