                ...
                if len(output_shape) >= 2:
                    ...
                    if sidecar_labels_path.exists():
                        ...
                        if model_output_size != len(self.classes):
                            print(f'[ML_MODEL] Warning: Jumlah output model ({model_output_size}) tidak sesuai jumlah labels.json ({len(self.classes)}). Menggunakan {model_output_size} label pertama.')
