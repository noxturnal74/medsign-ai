...
| `sembuh` | 20 | 1 | 0.00% | low_sample |
| `resep` | 15 | 1 | 0.00% | low_sample |
| `alergi` | 15 | 1 | 0.00% | low_sample |
| `berapa` | 15 | 1 | 0.00% | low_sample |
| `kapan` | 15 | 1 | 0.00% | low_sample |
| `pagi` | 15 | 1 | 0.00% | low_sample |
| `siang` | 15 | 1 | 0.00% | low_sample |
| `malam` | 30 | 2 | 0.00% | ok |
...
| `dingin` | 0 | 0 | - | missing |
| `bahaya` | 0 | 0 | - | missing |
| `istirahat` | 0 | 0 | - | missing |
| `bantuan` | 0 | 0 | - | missing |
| `apa` | 0 | 0 | - | missing |
| `siapa` | 0 | 0 | - | missing |
| `di mana` | 0 | 0 | - | missing |
| `mengapa` | 0 | 0 | - | missing |
| `bagaimana` | 0 | 0 | - | missing |
| `berapa lama` | 0 | 0 | - | missing |
...
| `meriang` | 0 | 0 | - | missing |
| `kaku` | 0 | 0 | - | missing |
| `mati rasa` | 0 | 0 | - | missing |
| `sakit kepala` | 0 | 0 | - | missing |
| `cedera` | 0 | 0 | - | missing |
| `apotek` | 0 | 0 | - | missing |
| `tablet` | 0 | 0 | - | missing |
| `kapsul` | 0 | 0 | - | missing |
| `sirup` | 0 | 0 | - | missing |
| `antibiotik` | 0 | 0 | - | missing |
| `vitamin` | 0 | 0 | - | missing |
| `dosis` | 0 | 0 | - | missing |
| `minum obat` | 0 | 0 | - | missing |
| `sebelum makan` | 0 | 0 | - | missing |
| `sesudah makan` | 0 | 0 | - | missing |
| `hari` | 0 | 0 | - | missing |
| `minggu` | 0 | 0 | - | missing |
| `bulan` | 0 | 0 | - | missing |
| `kontrol` | 0 | 0 | - | missing |
| `terapi` | 0 | 0 | - | missing |
| `rehabilitasi` | 0 | 0 | - | missing |
| `efek samping` | 0 | 0 | - | missing |
| `pemeriksaan` | 0 | 0 | - | missing |
| `hasil` | 0 | 0 | - | missing |
| `tes` | 0 | 0 | - | missing |
| `urine` | 0 | 0 | - | missing |
| `tekanan darah` | 0 | 0 | - | missing |
| `berat badan` | 0 | 0 | - | missing |
| `tinggi badan` | 0 | 0 | - | missing |
| `suhu tubuh` | 0 | 0 | - | missing |
| `denyut nadi` | 0 | 0 | - | missing |
| `napas cepat` | 0 | 0 | - | missing |
| `napas lambat` | 0 | 0 | - | missing |
| `foto rontgen` | 0 | 0 | - | missing |
| `usg` | 0 | 0 | - | missing |
| `ct scan` | 0 | 0 | - | missing |
| `mri` | 0 | 0 | - | missing |
| `positif` | 0 | 0 | - | missing |
...
| `stres` | 0 | 0 | - | missing |
| `nyaman` | 0 | 0 | - | missing |
| `tidak nyaman` | 0 | 0 | - | missing |
| `sehat` | 0 | 0 | - | missing |
| `pendaftaran` | 0 | 0 | - | missing |
| `nomor antrean` | 0 | 0 | - | missing |
| `ruang tunggu` | 0 | 0 | - | missing |
| `ruang periksa` | 0 | 0 | - | missing |
| `kamar pasien` | 0 | 0 | - | missing |
| `instalasi gawat darurat` | 0 | 0 | - | missing |
| `dokter spesialis` | 0 | 0 | - | missing |
| `jadwal` | 0 | 0 | - | missing |
| `janji temu` | 0 | 0 | - | missing |
| `rujukan` | 0 | 0 | - | missing |
| `administrasi` | 0 | 0 | - | missing |
| `pembayaran` | 0 | 0 | - | missing |
| `bpjs` | 0 | 0 | - | missing |
| `asuransi` | 0 | 0 | - | missing |
| `identitas` | 0 | 0 | - | missing |
| `kartu pasien` | 0 | 0 | - | missing |
| `pendamping` | 0 | 0 | - | missing |
| `wali` | 0 | 0 | - | missing |
| `tanda tangan` | 0 | 0 | - | missing |
| `selesai` | 0 | 0 | - | missing |
